...
$crpt = new Crypto();
$id = $crpt->decrypt($_GET['transaksi']);

if(!is_numeric($id)) die("Fail");

$show = $proses->editTransaksi($id);
...
$pdf->Cell(34 ,5,': COZ-'.strtoupper(dechex($data->kd_transaksi)),0,1);//end of line
