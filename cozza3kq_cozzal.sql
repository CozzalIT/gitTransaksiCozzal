...
--
-- Host: localhost
-- Generation Time: Dec 20, 2017 at 09:23 PM
...
(1, 'Newton', 'Buah Batu'),
(2, 'Jardin', 'Cihampelas'),
(3, 'Metro The Suite', 'Metro Sukarno Hatta'),
(4, 'Gateway', 'Cicadas');
...
(22, 'AA Yoman', 'Jalan Pungkur', '082666544', 'Laki-laki', '', '0000-00-00');
...
ALTER TABLE `tb_owner`
  ADD PRIMARY KEY (`kd_owner`), ADD KEY `kd_bank` (`kd_bank`), ADD KEY `kd_apt` (`kd_apt`);
...
--
ALTER TABLE `tb_unit`
  ADD PRIMARY KEY (`kd_unit`), ADD KEY `kd_apt` (`kd_apt`);
...
--
ALTER TABLE `tb_penyewa`
  MODIFY `kd_penyewa` int(4) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=23;
--
...
--
ALTER TABLE `tb_transaksi`
  MODIFY `kd_transaksi` int(4) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=50;
--
