...
class Owner {
  ...
  public function showBooking($kd_unit){
    $sql = "SELECT
      tb_transaksi.kd_transaksi, tb_transaksi.kd_penyewa, tb_transaksi.kd_apt, tb_transaksi.kd_unit, tb_transaksi.tamu, tb_transaksi.check_in, tb_transaksi.check_out, tb_transaksi.hari, tb_transaksi.tgl_transaksi, tb_transaksi.hari_weekday, tb_transaksi.hari_weekend,
  ...
  public function showConfirm($kd_unit){
    $sql = "SELECT
      tb_confirm_transaksi.kd_confirm_transaksi, tb_confirm_transaksi.kd_penyewa, tb_confirm_transaksi.kd_apt, tb_confirm_transaksi.kd_unit, tb_confirm_transaksi.tamu, tb_confirm_transaksi.check_in, tb_confirm_transaksi.check_out, tb_confirm_transaksi.hari, tb_confirm_transaksi.tgl_transaksi, tb_confirm_transaksi.hari_weekday, tb_confirm_transaksi.hari_weekend,
      tb_penyewa.kd_penyewa, tb_penyewa.nama,
      tb_apt.kd_apt, tb_apt.nama_apt,
      tb_unit.kd_unit, tb_unit.no_unit, tb_unit.h_owner_wd, tb_unit.h_owner_we
