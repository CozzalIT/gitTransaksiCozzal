        ...
        <div class="widget-box" style="overflow-x:auto;">
          ...
          <div class="widget-content nopadding">
            ...
            <div class="widget-content">
              <form id="formTU" action="../../../proses/transaksi_umum.php" method="POST" class="form-horizontal">
                <div class="control-group">
                  <label class="control-label">Kebutuhan : </label>
                  <div class="controls">
                    <select id="kebutuhan" name="kebutuhan">
                      <option>-- Pilih Kebutuhan --</option>
                      <option onclick="jenisKebutuhan('TU')">Transaksi Umum</option>
                      <option onclick="jenisKebutuhan('U')">Kebutuhan Unit</option>
                      <option onclick="jenisKebutuhan('B')">Billing</option>
                    </select>
                  </div>
                </div>
                <script>
                  function jenisKebutuhan(jenis){
                    ...
                    var btnTU = document.getElementById("btnTU");
                    ...
                    if(jenis=="TU"){
                      ...
                      btnUnit.classList.add("hide");
                      btnTU.classList.remove("hide");
                    }else if(jenis=="U"){
                      selectApt.classList.remove("hide");
                      selectUnit.classList.remove("hide");
                      btnUnit.classList.remove("hide");
                      btnTU.classList.add("hide");
                    }else{
                      selectApt.classList.add("hide");
                      selectUnit.classList.add("hide");
                      btnUnit.classList.add("hide");
                ...
                <div id="allForm" class="hide">
                  ...
                  <div class="control-group">
                    <div class="controls">
                      <button id="btnTU" class="btn btn-success hide" name="addTransaksiUnit" onclick="actionTU()">Submit</button>
                      <button id="btnUnit" class="btn btn-success" name="addTransaksiUmum" onclick="actionTU()">Submit</button>
              ...
              <script>
                function actionTU(){
                  document.getElementById("formTU").submit();
                }
              </script>
            </div>
          </div>
